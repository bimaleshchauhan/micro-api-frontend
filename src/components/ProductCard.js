...
const ProductCard = ({item}) => {
    ...
    const {_id,banner, available, price, name, desc, type} = item;
        ...
        className="" style={{ textDecoration: 'none'}}>
                <div className="bg-white m-3" style={{ width: '12rem', height: '22rem', flexDirection: 'column', justifyContent: 'space-around',  display: 'flex', paddingTop: '1rem', paddingBottom: '0.5rem', borderRadius: 7  }}>
